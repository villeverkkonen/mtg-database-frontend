            ...
            <div className="draftingInfo">
                ...
                ?
                    <div className="draftingInfoText">
                        ...
                        <p>Everybody opens the first booster and picks one card (computers by random, no AI yet).</p>
                        ...
                        <p>After drafting all 3 boosters you should have a 45 card deck.</p>
                    </div>
                :
                    null
                }
